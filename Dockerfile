...
# Please be aware that due to the usage of a "distroless" image the usage of `fly ssh console` is not possible, because no console is available.
# If you want to use the console, please use `alpine:latest` as your base image.
